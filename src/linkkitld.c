...
/*
 * user connected to ali iot platform event handler.
 */
...
/*
 * user disconnected from ali iot platform event handler.
 */
...
static int user_permit_join(void)
{
    EXAMPLE_TRACE("user permet join.");
    return 0;
}
